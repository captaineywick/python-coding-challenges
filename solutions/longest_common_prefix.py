def find_common_prefix() -> str:
    ...
    words.sort()
    print(words)  # Debug: see the sorted list

    first_str = words[0]  # First string after sorting
    last_str = words[-1]  # Last string after sorting
    print(first_str, last_str)  # Debug: see which two strings are compared
    print(len(first_str), len(last_str))  # Debug: length
    ...
    print(common_prefix)  # Debug: see the final common prefix
